                ...
                <div className="flex items-baseline justify-between border-gray-200 pb-6  ">
                    <div className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                        <section aria-labelledby="products-heading" className="pb-24 pt-1">
                            <form className="hidden lg:block pl-12">
                                ...
                                <Tabs defaultValue='music' className='h-full space-y-6'>
                                    <TabsContent value='music' className='border-none p-0 outline-none'>
                                        ...
                                        <div className="flex ...">
                                            ...
                                            <div className="flex-auto w-64 pt-3">

                                                <input type="search" name="" id="" className='border-2 rounded-md w-2/3 p-1 ' placeholder='Search' />
                                            </div>
                                            <div className="flex-auto w-32 ...">
                                                <div className="flex flex-row pt-2">
                                                    <div className="basis-1/2 "> Sắp xếp</div>
                                                    <div className="basis-1/3"><Select>
                                        ...
                                        <div className=' grid grid-cols-3 gap-12 px-8 py-2 bg-pink-200'>
                                                ...
                                                <div className='group/edit invisible group-hover/item:visible absolute top-0 left-0 row columns-2 pt-16 pl-14 grid grid-rows-2 grid-flow-col gap-2 text-pink-200'>
                                                    {/* <AlertDialog>
                                                        <AlertDialogTrigger asChild>
                                                            <Button variant='default' className='font-sans text-base w-32 px-2'>
                                                                {' '}
                                                                Xem trước
                                                            </Button>
                                                        </AlertDialogTrigger>
                                                        <AlertDialogContent>
                                                            <AlertDialogHeader className=''>
                                                                ...
                                                                <AlertDialogTitle>sản phẩm 3</AlertDialogTitle>
