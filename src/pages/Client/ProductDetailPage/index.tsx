        ...
        <div>
            <div className='flex font-sans flex flex-row px-40'>
                <div className='flex-none  relative basis-1/3 '>
                    <img
                        src='https://picsum.photos/320/350'
                        alt=''
                ...
                <form className='flex-auto pl-10 basis-2/3 pr-48'>
                    ...
                    <div className='flex space-x-4 mb-6 text-sm font-medium'>
                        ...
                        <button
                            className='flex-none flex items-center justify-center w-9 h-9 rounded-md text-pink-400 border border-slate-200'
                            type='button'
                            aria-label='Like'
                        >
            ...
            <div className=' px-24 pt-10'>
                ...
                <div className='flex flex-row pt-5 '>
                    ...
                    <div className='grid w-3/6 gap-2'>
                        ...
                        <p>
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eum reiciendis praesentium
                            assumenda veniam optio. Ipsum, nihil iure! Voluptatem facilis expedita, asperiores
                            laudantium quasi aliquam ullam officiis maiores iusto error illo.
                        </p>
                    </div>
                </div>
            </div>
                                                    ...
                                                    <div className='flex flex-row pb-2 px-2'>
                                                        <div className='border-solid border-pink-200 border-2 rounded-full p-2 '>
                                                            <svg
                                                                ...
                                                                height='20'
                                                                fill='currentColor'
                                                                className='bi bi-suit-heart basis-1/2 '
                                                                viewBox='0 0 16 16'
                                                            >
                                                        ...
                                                        <div className='border-solid border-pink-200 border-2 rounded-full p-2 ml-6'>
                                                            <svg
                                                                ...
                                                                height='20'
                                                                fill='currentColor'
                                                                className='bi bi-search basis-1/2'
                                                                viewBox='0 0 16 16'
                                                            >
