        ...
        <div className=' px-24 pt-10 m-5'>
            ...
            <div className="flex flex-row pt-5 ">
                ...
                <div className="grid w-3/6 gap-2">
                    ...
                    <p className='capitalize hover:uppercase'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eum reiciendis praesentium assumenda veniam optio. Ipsum, nihil iure! Voluptatem facilis expedita, asperiores laudantium quasi aliquam ullam officiis maiores iusto error illo.</p>
                </div>
            </div>
        </div >
    )
