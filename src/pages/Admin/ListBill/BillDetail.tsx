...
const BillDetail = () => {
    ...
    return (
        <div className='rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark my-2 '>
            <div className='flex flex-row  mt-4 ml-10 gap-80'>
                <h4 className='text-2xl font-bold text-black dark:text-white pb-5  mt-10' id='name-bill'>
                    Hóa đơn chi tiết
                </h4>

                <button
                    className='flex flex-row gap-3 bg-blue-500 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded h-10 w-40 mt-10 hover:bg-blue-300'
                    onClick={handlePrint}
                >
                    <svg
            ...
            <div id='bill-detail' className=' border-2 border-blue-200  w-2/3 rounded mx-10'>
                <div className='py-6  md:px-6 xl:px-7.5 '>
                    ...
                    <div className=' gap-3 font-thin text-base  flex flex-row pt-2'>
